<?php /*
* 14May15 zig - add class to blog block s.t. we can style it.
* 27july - only do 6 post/page on home page & dont show the load more
*/ ?>
<?php
	if (!empty($_POST['ajax'])) {
	...
	if (empty($_POST['ajax'])):
		...
		<div class="<?php echo $class_container; ?>">
			...
			<main>
				...
				?>
				<div class="grid-row zpage-bottom-blog">
...
/**************************** IF NOT AJAX *********************************/
						...
						<?php if (is_front_page() and is_active_sidebar('homebottom')) {
							echo '<div class="grid-row zpage-home-bottom">';
							dynamic_sidebar( 'homebottom' );
							echo '</div>';
						} ?>
