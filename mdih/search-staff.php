...
/* 
* mods:
*	use hotfix from theme developer.
* 	10jun15 - make title of staff member linked.
*   14Aug15 - make providers alphabetical - removed 21Aug15, using post order plugin. 
*/
										...
										while ($r->have_posts()):
											...
											<div class='item clearfix'>
												<?php
													...
													$title = get_the_title();
													echo $title ? "<div class='widget-title'><a href=" . get_permalink() . ">" . $title . "</a></div>" : "";
